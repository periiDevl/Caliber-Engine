...
int main()
{
	...
	*/
	...
	//MAKE SURE TO CHANGE MAIN.CPP AND SEE IF IT CHANGES HOT RELOAD
	/*
	std::string get_file_contents("src/Camera.cpp");
	
	std::ifstream in("src/Camera.cpp", std::ios::binary);
	if (in)
	{
		std::string contents;
		...
		string text("get real dumbass\n");
		string filename2("Camera.txt");
		fstream outfile;
